...
```sh
git clone https://github.com/dialextremo/kickstart-modular.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/dialextremo/kickstart-modular.nvim.git "%localappdata%\nvim"
```
